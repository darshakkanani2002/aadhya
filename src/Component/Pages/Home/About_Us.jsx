...
export default function About_Us() {
    ...
    return (
        <div >
            ...
            <div className='to-provide-smart-sec py-5 d-none'>
                ...
                {/* <div className='container'>
                    <div className='row'>
                        <div className='col-lg-4 mt-120 px-4'>
                            <h2>Our Service</h2>
                            <p>As one of the leading software development companies, we at Vasundhara have a diverse range of services for our clients, where we operate in these core areas services.</p>

                            <div>
                                <div className='our-services-01 mt-60'>
                        ...
                        <div className='col-lg-4 px-4 mt-lg-0 mt-md-5 mt-5'>
                            <div className='mb-5'>
